...
(n: Int) {
    var count = n
        private set
    private val id: IntArray = IntArray(count) { it }    // id[i] = component identifier of i
    ...
    fun union(p: Int, q: Int) {
        validate(p)
        validate(q)
        val pID = id[p]   // needed for correctness
        val qID = id[q]   // to reduce the number of array accesses
